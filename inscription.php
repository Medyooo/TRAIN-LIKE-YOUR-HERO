				...
				<div class="container">
					...
					<div class="row">	
						<div class="col-md-4 animate-box">
                             <form action="action.php" method="POST" style="margin-left: 30%;">
                                 <h3 class="section-title">Join our family</h3>
<div class="mb-3 col-5 ">
    <label for="exampleInputPassword1" class="form-label">Last Name</label>
    <input type="text" class="form-control" name="nom1" id="exampleInputPassword1">
  </div>

  <div class="mb-3 col-5 ">
    <label for="exampleInputPassword1" class="form-label">First Name</label>
    <input type="text" class="form-control" name="prenom1" id="exampleInputPassword1">
  </div>

  <div class="mb-3 col-5 ">
    <label for="exampleInputEmail1" class="form-label">User Name</label>
    <input type="text" class="form-control" name="pseudo1" id="exampleInputEmail1" aria-describedby="emailHelp">
   </div>
  ...
  <div class="mb-3 col-5 ">
    ...
    <input type="password" class="form-control" name="motde1" id="exampleInputPassword1">
  </div>
 

  <div class="mb-3 col-5 ">
    <label for="exampleInputPassword1" class="form-label">Password Confirmation</label>
    <input type="password" class="form-control" name="motde2" id="exampleInputPassword2">
  </div>
