				...
				$mysqli = new mysqli('localhost','med-elbaidi','@Callmemed2002','zfl2-zel_baimo');
                      ...
                      while ($oeuvre = $result1->fetch_assoc())
                    {
				         ...
				         echo'<div class="col-md-4 col-sm-6">
                          ...
                          <a href="./oeuvre.php?ovr_code='.$oeuvre['ovr_code'].'">
						<div class="team-section-grid ">
                       <div class="team-section-grid animate-box" style="background-image: url(images/'.$oeuvre['ovr_fichier_img'].');">
							<div class="overlay-section">
								<div class="desc">
                                    
									<h3>'.$oeuvre['ovr_intitule'].'</h3>
									<p>'.$oeuvre['ovr_date_creation'].'</p>
                                    </a>
                               </div>
